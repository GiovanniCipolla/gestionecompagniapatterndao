...
public class testImpiegato {
	...
	private static void testInsertImpiegato(CompagniaDAO compagniaDAOInstance, ImpiegatoDAO impiegatoDAOInstance) throws Exception {
		...
		int quantiInseriti = impiegatoDAOInstance.insert(
				new Impiegato("Angelica", "Cast", "adadf66198fd89s8", dataNascita, dataAssunzione, compagniaPerImpiegato));
